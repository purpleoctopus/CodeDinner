...
{
    Task<ApiResponse<List<CourseDetailDto>>> GetAllForStudentAsync(Guid requestingUserId); 
    Task<ApiResponse<List<CourseDetailDto>>> GetAllForAuthorAsync(Guid requestingUserId); 
